...
class TradingAgent:
    ...
    def _get_bitso_balance(self) -> Dict[str, Any]:
    ...
    def _get_okx_balance(self) -> Dict[str, Any]:
        ...
        try:
            ...
            signature = hmac.new(self.okx_secret.encode('utf-8'), message.encode('utf-8'), hashlib.sha256).hexdigest()
    ...
    def on_phase_0(self, payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            "bitso": self._get_bitso_balance(),
            "okx": self._get_okx_balance(),
    ...
    def on_phase_90(self, payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {"status": "STRATEGY_READY", "spread_detected": 0.0012, "recommended_action": "HOLD_MONITOR"}

    def on_phase_180(self, payload: Dict[str, Any]) -> Dict[str, Any]:
        logging.info(f"[{self.name}] 180°: Verificando filtros de seguridad...")
        return {"status": "EXECUTION_ROUTER_READY", "mode": "IP_SECURE_ROUTING"}

    def on_phase_270(self, payload: Dict[str, Any]) -> Dict[str, Any]:
        logging.info(f"[{self.name}] 270°: Cierre de pulso y sincronizacion de registros...")
        return {"status": "LEDGER_SYNCHRONIZED", "timestamp": time.time()}